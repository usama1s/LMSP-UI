...
const AddAccountForm = () => {
  // ** hooks call
  const { user, customApiCall } = useAuth()
  // ** State
  ...
  const handleSaveChanges = async () => {
    ...
    if (isAnyFieldEmpty) {
      ...
      try {
        ...
        dataForApiCall.append('register_date', formData.registrationDate?.toDateString())
        ...
        dataForApiCall.append('role', '1')
        const res = await customApiCall('post', 'auth/register', dataForApiCall)
        ...
        <Grid container spacing={7}>
          <Grid item xs={12} sx={{ marginTop: 4.8, marginBottom: 3 }}>
            <Box sx={{ display: 'flex', alignItems: 'center' }}>
              <ImgStyled src={formData.profileImage} alt='Profile Pic' />
              <Box>
          ...
          <Grid item xs={12} sm={6}>
            <FormControl fullWidth>
              ...
              >
                <MenuItem value='2'>Student Incharge</MenuItem>
                <MenuItem value='3'>Instructor Incharge</MenuItem>
                <MenuItem value='4'>Inventory Incharge</MenuItem>
